...
<html lang="en">
    <head>
        ...
        <title>Customers Overview · POS.PHP</title>
    </head>
                ...
                <div class="container-fluid">
                    <div class="card mb-5">
                        <div class="card-header">
                            <h3 class="card-title">Customers Personal Information</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form method="POST" action="" enctype="multipart/form-data" id="customer_form">
                            <input type="hidden" name="size" value="1000000">
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    <label for="inputText">First Name</label>
                                    <input type="text" class="form-control fname" id="inputText" name="fname" placeholder="Enter first name..." required>
                                </div>
                                <div class="col-sm-6">
                                    <label for="inputText">Last Name</label>
                                    <input type="text" class="form-control lname" id="inputText" name="lname" placeholder="Enter last name..." required>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-sm-4">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="exampleInputFile" accept="image/*" onchange="customerloadFile(event)" name="customer_img">
                            ...
                            <div class="form-group">
                                ...
                                <div class="img-pr">
                                    <img class="img-fluid img-thumbnail img-preview" width="150" height="150" src="../assets/images/product-preview.png" alt="customer image preview" id="customer_output"/>
                                </div>
                            </div>
                        </div>
                        <!-- /.card-body -->
                        <div class="card-footer">
                            ...
                            <button class="btn btn-success create-customers" type="Submit"><i class="fa fa-check"></i> Submit</button>
                        </div>
                            </form>
                    </div>
                    <!-- /.card -->
