...
<html lang="en">
    <head>
        ...
        <title>Orders Overview · POS.PHP</title>
    </head>
                            ...
                            <!-- Table row -->
                                ...
                                <div class="row no-print">
                                    <div class="col-12">
                                        ...
                                        <button type="button" class="btn btn-success float-right"><i class="far fa-envelope"></i> Send Email
                                        </button>
